        ...
        <SafeAreaProvider>
            <SafeAreaView style={styles.container}>
                <View style={{ gap: 4 }}>
                    ...
                    <Text variant="text-md/normal">A crash occurred while rendering a component. This could be caused by a plugin, Zancord, or Discord itself.</Text>
                    <Text variant="text-sm/normal" color="text-muted">{debugInfo.os.name}; {debugInfo.discord.build} ({debugInfo.discord.version}); {debugInfo.zancord.version}</Text>
                </View>
