import { ApplicationCommand, ApplicationCommandInputType, ApplicationCommandType, ZancordApplicationCommand } from "@lib/api/commands/types";
...
export function registerCommand(command: ZancordApplicationCommand): () => void {
